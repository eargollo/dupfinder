...
var rootCmd = &cobra.Command{
	...
	Long: `dupfinder is a tool that can be used to 
find and clean duplicated files in multiple volumes or folders.
The tool caches file signatures (MD5) to speed up multiple 
executions.`,
